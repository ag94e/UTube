                        ...
                        <div class="container">
                            ...
                            <div class="d-flex justify-content-center">
                                <form>
                                    ...
                                    <div class="mb-4">
                                        <label for="password2" class="form-label font-weig-bold">Confirmar contraseña</label>
                                        <input type="password" class="form-control mb-2" placeholder="Confirma tu contraseña" id="password2">
                                    </div>
